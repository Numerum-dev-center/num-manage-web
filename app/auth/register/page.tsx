...
export default function RegisterPage() {
  ...
  const roles: RegisterFormData['role'][] = ['Student', 'Professional', 'Instructor'];
            ...
            <div className="flex gap-2 w-full">
              {roles.map((role) => (
                <button
                  ...
                  className={`flex-1 py-2.5 px-3 flex items-center justify-center gap-2 border rounded-lg text-xs font-medium transition-all outline-none ${
                    formData.role === role
                ...
                >
                  ...
                  <div className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center ${
                    formData.role === role ? 'border-[#076648]' : 'border-[#81bdaa]/60'
                  }`}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border bg-[#fcfefd] text-[#076648] outline-none transition-all ${
                  errors.name 
            ...
            {errors.name && <p className="text-xs text-[#ef4726]">{errors.name}</p>}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full pl-10 pr-10 py-3 rounded-lg border bg-[#fcfefd] text-[#076648] outline-none transition-all ${
                  errors.password 
                    ? 'border-[#ef4726] focus:ring-1 focus:ring-[#ef4726]' 
                    : 'border-[#81bdaa]/60 focus:border-[#076648] focus:ring-1 focus:ring-[#076648]'
                }`}
