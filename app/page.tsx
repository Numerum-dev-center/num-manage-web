      ...
      <header className="fixed top-0 w-full bg-[#fcfefd]/80 dark:bg-[#032117]/80 backdrop-blur-md z-50 border-b border-[#81bdaa]/20">
        <div className="max-w-7xl mx-auto h-20 px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button className="text-sm font-bold text-[#076648] dark:text-[#fcfefd] hover:opacity-80 transition-opacity">
              Connexion
            </button>
            <button className="flex items-center gap-2 px-5 py-2.5 bg-[#076648] text-[#fcfefd] dark:bg-[#fcfefd] dark:text-[#076648] rounded-xl text-sm font-bold shadow-sm hover:scale-[1.02] active:scale-[0.98] transition-all">
              Rejoindre le Hub <ChevronRight size={16} />
            </button>
          </div>
